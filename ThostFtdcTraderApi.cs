...
namespace LvHui.CTPTrader4CS
{
    ...
    public class CThostFtdcTraderApi
    {
        ...
        {
            STraderSpi sspi = new STraderSpi();

            sspi.m_pfOnFrontConnected = pSpi.OnFrontConnected ;
            sspi.m_pfOnFrontDisconnected = pSpi.OnFrontDisconnected ;
            sspi.m_pfOnHeartBeatWarning = pSpi.OnHeartBeatWarning ;
            sspi.m_pfOnRspAuthenticate = pSpi.OnRspAuthenticate ;
            sspi.m_pfOnRspUserLogin = pSpi.OnRspUserLogin ;
            sspi.m_pfOnRspUserLogout = pSpi.OnRspUserLogout ;
            sspi.m_pfOnRspUserPasswordUpdate = pSpi.OnRspUserPasswordUpdate ;
            sspi.m_pfOnRspTradingAccountPasswordUpdate = pSpi.OnRspTradingAccountPasswordUpdate ;
            sspi.m_pfOnRspOrderInsert = pSpi.OnRspOrderInsert ;
            sspi.m_pfOnRspParkedOrderInsert = pSpi.OnRspParkedOrderInsert ;
            sspi.m_pfOnRspParkedOrderAction = pSpi.OnRspParkedOrderAction ;
            sspi.m_pfOnRspOrderAction = pSpi.OnRspOrderAction ;
            sspi.m_pfOnRspQueryMaxOrderVolume = pSpi.OnRspQueryMaxOrderVolume ;
            sspi.m_pfOnRspSettlementInfoConfirm = pSpi.OnRspSettlementInfoConfirm ;
            sspi.m_pfOnRspRemoveParkedOrder = pSpi.OnRspRemoveParkedOrder ;
            sspi.m_pfOnRspRemoveParkedOrderAction = pSpi.OnRspRemoveParkedOrderAction ;
            sspi.m_pfOnRspQryOrder = pSpi.OnRspQryOrder ;
            sspi.m_pfOnRspQryTrade = pSpi.OnRspQryTrade ;
            sspi.m_pfOnRspQryInvestorPosition = pSpi.OnRspQryInvestorPosition ;
            sspi.m_pfOnRspQryTradingAccount = pSpi.OnRspQryTradingAccount ;
            sspi.m_pfOnRspQryInvestor = pSpi.OnRspQryInvestor ;
            sspi.m_pfOnRspQryTradingCode = pSpi.OnRspQryTradingCode ;
            sspi.m_pfOnRspQryInstrumentMarginRate = pSpi.OnRspQryInstrumentMarginRate ;
            sspi.m_pfOnRspQryInstrumentCommissionRate = pSpi.OnRspQryInstrumentCommissionRate ;
            sspi.m_pfOnRspQryExchange = pSpi.OnRspQryExchange ;
            sspi.m_pfOnRspQryInstrument = pSpi.OnRspQryInstrument ;
            sspi.m_pfOnRspQryDepthMarketData = pSpi.OnRspQryDepthMarketData ;
            sspi.m_pfOnRspQrySettlementInfo = pSpi.OnRspQrySettlementInfo ;
            sspi.m_pfOnRspQryTransferBank = pSpi.OnRspQryTransferBank ;
            sspi.m_pfOnRspQryInvestorPositionDetail = pSpi.OnRspQryInvestorPositionDetail ;
            sspi.m_pfOnRspQryNotice = pSpi.OnRspQryNotice ;
            sspi.m_pfOnRspQrySettlementInfoConfirm = pSpi.OnRspQrySettlementInfoConfirm ;
            sspi.m_pfOnRspQryInvestorPositionCombineDetail = pSpi.OnRspQryInvestorPositionCombineDetail ;
            sspi.m_pfOnRspQryCFMMCTradingAccountKey = pSpi.OnRspQryCFMMCTradingAccountKey ;
            sspi.m_pfOnRspQryEWarrantOffset = pSpi.OnRspQryEWarrantOffset ;
            sspi.m_pfOnRspQryTransferSerial = pSpi.OnRspQryTransferSerial ;
            sspi.m_pfOnRspQryAccountregister = pSpi.OnRspQryAccountregister ;
            sspi.m_pfOnRspError = pSpi.OnRspError ;
            sspi.m_pfOnRtnOrder = pSpi.OnRtnOrder ;
            sspi.m_pfOnRtnTrade = pSpi.OnRtnTrade ;
            sspi.m_pfOnErrRtnOrderInsert = pSpi.OnErrRtnOrderInsert ;
            sspi.m_pfOnErrRtnOrderAction = pSpi.OnErrRtnOrderAction ;
            sspi.m_pfOnRtnInstrumentStatus = pSpi.OnRtnInstrumentStatus ;
            sspi.m_pfOnRtnTradingNotice = pSpi.OnRtnTradingNotice ;
            sspi.m_pfOnRtnErrorConditionalOrder = pSpi.OnRtnErrorConditionalOrder ;
            sspi.m_pfOnRspQryContractBank = pSpi.OnRspQryContractBank ;
            sspi.m_pfOnRspQryParkedOrder = pSpi.OnRspQryParkedOrder ;
            sspi.m_pfOnRspQryParkedOrderAction = pSpi.OnRspQryParkedOrderAction ;
            sspi.m_pfOnRspQryTradingNotice = pSpi.OnRspQryTradingNotice ;
            sspi.m_pfOnRspQryBrokerTradingParams = pSpi.OnRspQryBrokerTradingParams ;
            sspi.m_pfOnRspQryBrokerTradingAlgos = pSpi.OnRspQryBrokerTradingAlgos ;
            sspi.m_pfOnRtnFromBankToFutureByBank = pSpi.OnRtnFromBankToFutureByBank ;
            sspi.m_pfOnRtnFromFutureToBankByBank = pSpi.OnRtnFromFutureToBankByBank ;
            sspi.m_pfOnRtnRepealFromBankToFutureByBank = pSpi.OnRtnRepealFromBankToFutureByBank ;
            sspi.m_pfOnRtnRepealFromFutureToBankByBank = pSpi.OnRtnRepealFromFutureToBankByBank ;
            sspi.m_pfOnRtnFromBankToFutureByFuture = pSpi.OnRtnFromBankToFutureByFuture ;
            sspi.m_pfOnRtnFromFutureToBankByFuture = pSpi.OnRtnFromFutureToBankByFuture ;
            sspi.m_pfOnRtnRepealFromBankToFutureByFutureManual = pSpi.OnRtnRepealFromBankToFutureByFutureManual ;
            sspi.m_pfOnRtnRepealFromFutureToBankByFutureManual = pSpi.OnRtnRepealFromFutureToBankByFutureManual ;
            sspi.m_pfOnRtnQueryBankBalanceByFuture = pSpi.OnRtnQueryBankBalanceByFuture ;
            sspi.m_pfOnErrRtnBankToFutureByFuture = pSpi.OnErrRtnBankToFutureByFuture ;
            sspi.m_pfOnErrRtnFutureToBankByFuture = pSpi.OnErrRtnFutureToBankByFuture ;
            sspi.m_pfOnErrRtnRepealBankToFutureByFutureManual = pSpi.OnErrRtnRepealBankToFutureByFutureManual ;
            sspi.m_pfOnErrRtnRepealFutureToBankByFutureManual = pSpi.OnErrRtnRepealFutureToBankByFutureManual ;
            sspi.m_pfOnErrRtnQueryBankBalanceByFuture = pSpi.OnErrRtnQueryBankBalanceByFuture ;
            sspi.m_pfOnRtnRepealFromBankToFutureByFuture = pSpi.OnRtnRepealFromBankToFutureByFuture ;
            sspi.m_pfOnRtnRepealFromFutureToBankByFuture = pSpi.OnRtnRepealFromFutureToBankByFuture ;
            sspi.m_pfOnRspFromBankToFutureByFuture = pSpi.OnRspFromBankToFutureByFuture ;
            sspi.m_pfOnRspFromFutureToBankByFuture = pSpi.OnRspFromFutureToBankByFuture ;
            sspi.m_pfOnRspQueryBankAccountMoneyByFuture = pSpi.OnRspQueryBankAccountMoneyByFuture ;
            sspi.m_pfOnRtnOpenAccountByBank = pSpi.OnRtnOpenAccountByBank ;
            sspi.m_pfOnRtnCancelAccountByBank = pSpi.OnRtnCancelAccountByBank ;
            sspi.m_pfOnRtnChangeAccountByBank = pSpi.OnRtnChangeAccountByBank ;

            ThostFtdcTraderApiAdapter.RegisterSpi(pTraderApi, ref sspi);
        }
